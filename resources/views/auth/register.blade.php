              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="input-group input-group-outline mb-3 @error('name') is-invalid is-filled @enderror">
                    ...
                    <div class="input-group input-group-outline mb-3 @error('email') is-invalid is-filled @enderror">
                    ...
                    <div class="input-group input-group-outline mb-3 @error('password') is-invalid is-filled @enderror">
                    ...
                    <div class="input-group input-group-outline mb-3 @error('password_confirmation') is-invalid is-filled @enderror">
                    ...
                    <div class="input-group input-group-dynamic mb-3 @error('address') is-invalid is-filled @enderror">
                      
                      <textarea type="text" class="form-control @error('address') is-invalid @enderror" placeholder="Address" name="address" rows="3"></textarea>
                      @error('address')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
